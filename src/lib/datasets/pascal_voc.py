...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        # self._classes = ('__background__', "bullet","dagger")
        self._classes = ('__background__', "bullet", "dagger", "defibrillator", "fruit_knife", "gas", "lighter_gas", "national_knife","paper_knife", "simulation_gun", "switchblade")
