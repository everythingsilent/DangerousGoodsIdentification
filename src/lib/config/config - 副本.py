...
tf.app.flags.DEFINE_integer('max_iters', 15, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 40000, "Step size for reducing the learning rate, currently only support one step")
...
tf.app.flags.DEFINE_integer('snapshot_iterations', 5, "Iteration to take snapshot")
